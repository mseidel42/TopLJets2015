...
options.register('scale', 1., VarParsing.VarParsing.multiplicity.singleton,VarParsing.VarParsing.varType.float, "mu^2")
if(hasattr(sys, "argv")):
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
     ...
     PythiaParameters = cms.PSet(
         processParameters = cms.vstring(
             ...
             'Top:gg2ttbar    = on',
             'Top:qqbar2ttbar = on',
             'SpaceShower:renormMultFac = ' + str(options.scale),
             'SpaceShower:factorMultFac =' + str(options.scale),
             '6:m0 = 172.5',    # top mass'
         ),
